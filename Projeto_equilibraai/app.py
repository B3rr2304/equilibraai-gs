#Front end do projeto, aplicação no streamlit para rodar em núvem, parte visaual do projeto
...
with col1:
    ...
    #correção de problema para ver se a skill python existe na lista
