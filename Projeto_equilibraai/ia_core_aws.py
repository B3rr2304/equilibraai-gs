# --- ia_core_aws.py ---
# Versão FINAL OTIMIZADA (TURBO)
# Faz apenas 4 consultas ao banco em vez de 400.
# Muito mais rápido para rodar no Streamlit.
...
# --- IMPORTAÇÃO SEGURA DO TENSORFLOW ---
# Tenta carregar IA. Se falhar (comum em alguns ambientes), segue sem ela.
...
# Endpoint extraído dos seus logs anteriores
DB_HOST = "equilibraai.chu8u2i8kdfr.sa-east-1.rds.amazonaws.com"
DB_NAME = "postgres"
DB_USER = "postgres"
DB_PASS = "FIAP-equilibraAI" # <--- ATENÇÃO: COLOQUE SUA SENHA DO RDS AQUI
DB_PORT = "5432"
...
def fetch_colaboradores_data():
    ...
    # 2. Busca TODAS as Skills de uma vez (Hard e Soft)
    ...
    # 4. Busca TODAS as Senioridades (Média) de uma vez
    ...
    # Isso cria um índice onde a chave é o ID do colaborador
    ...
    for _, row in df_colab.iterrows():
        ...
        # Recupera skills do grupo (se houver)
        h_skills = []
        s_skills = []
        ...
        # Recupera senioridade (ou 0.0 se não tiver)
        ...
        data_formatada.append({
            ...
            'carga_atual_percent': np.random.randint(20, 90), # Mock de carga (simulado)
...
# --- FUNÇÕES DE CÁLCULO DE MACHINE LEARNING ---
...
def calc_asp(t, a):
    ...
    try:
        ...
        # Nota: Para uma POC real perfeita, deveríamos calcular o embedding da tarefa (t) também.
